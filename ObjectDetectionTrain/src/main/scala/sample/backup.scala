...
object backup {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // initial zoo context
    val sparkConf = new SparkConf().setAppName("objectDetection").setMaster("local[*]")
    ...
    // load data
    val classes = Source.fromFile("C:/Users/Aswani/IdeaProjects/ObjectDetectionTrain/src/main/resources/ILSVRC/classname.txt").getLines().toArray
    val trainSet = SSDDataSet.loadSSDTrainSet("C:/Users/Aswani/IdeaProjects/ObjectDetectionTrain/src/main/resources/Output/train", sc, 300,
      4, None)
    val valSet = SSDDataSet.loadSSDValSet("C:/Users/Aswani/IdeaProjects/ObjectDetectionTrain/src/main/resources/Output/val", sc, 300, 4,
      None)

    // create ssd model and load weights from pretrained model
    val model = SSDVGG[Float](classes.length,300, "pascal")
    val m = ObjectDetector.loadModel("C:/Users/Aswani/IdeaProjects/ObjectDetectionTrain/src/main/resources/model/used/analytics-zoo_ssd-vgg16-300x300_PASCAL_0.1.0.model")
    ...
    model.saveModel("C:/Users/Aswani/IdeaProjects/ObjectDetectionTrain/src/main/resources/model/final", overWrite = false)
  }
  ...
  private def optimize(model: SSDVGG[Float],
    ...
    val estimator =
      Estimator[Float](model, optimMethod, "resources/model")
