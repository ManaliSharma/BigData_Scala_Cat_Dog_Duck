...
object ImageClassifier {
  private val log: Logger = LoggerFactory.getLogger(ImageClassifier.getClass)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val trainData = new ClassPathResource("/train").getFile
    ...
    val testData = new ClassPathResource("/test").getFile
