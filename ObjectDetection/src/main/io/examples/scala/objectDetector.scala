...
import object_detection.string_int_label_map.proto
...
object objectDetector {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val modelDir = args.lift(2).getOrElse("ssd_inception_v2_coco_2018_01_28")
    ...
    val labelMap: Map[Int, String] = {
      val pbText = Source.fromFile("/src/main/Resources/id.pbtxt").mkString
